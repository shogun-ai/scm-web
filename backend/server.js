...
function buildRuleBasedComplianceReview(loanDoc, policySources = [], source = 'rules') {
    ...
    checks.push({
        ...
        conflictReason: input.aiLoanOfficer?.status === 'completed'
            ? 'Зээлийн судалгаа / эргэн төлөлтийн чадварын үнэлгээний заалттай харьцуулахад AI дүгнэлт бүртгэгдсэн боловч хүний ажилтны баталгаажуулалт шаардлагатай тул хэсэгчлэн нийцсэн, нягтлах шаардлагатай.'
        ...
        finding: input.aiLoanOfficer?.status === 'completed'
            ? 'AI зээлийн ажилтны урьдчилсан дүгнэлт бүртгэгдсэн ч журмын шаардлагатай бүрэн нийцүүлэхийн тулд ажилтан баталгаажуулах шаардлагатай.'
