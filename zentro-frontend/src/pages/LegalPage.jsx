...
const UPDATED_AT = '2026 оны 8 дугаар сарын 26';
...
function PrivacyPolicy({ email }) {
  return (
    <div className="zl-content">
      ...
      <section>
        <span>03</span>
        <div><h2>Ашиглах зорилго</h2><p>Мэдээллийг таны хүсэлтийг хүлээн авах, тантай холбогдох, барьцаа болон зээлийн боломжийг урьдчилан үнэлэх, гэрээ үйлчилгээ бэлтгэх, төлөлт хянах, хэрэглэгчийн дэмжлэг үзүүлэх, залилан болон аюулгүй байдлын эрсдэлийг бууруулах зорилгоор ашиглана.</p><p>Мөн хууль, зохицуулагч байгууллагын шаардлага биелүүлэх, дотоод аудит, тайлан, үйлчилгээний чанар болон системийн найдвартай ажиллагааг сайжруулахад шаардлагатай хэмжээнд боловсруулна.</p><p>Та тусад нь зөвшөөрсөн тохиолдолд санал, шинэ бүтээгдэхүүний мэдээлэл хүргэх, сурталчилгааны үр дүн хэмжих болон тохирсон сурталчилгаа үзүүлэхэд Meta Pixel зэрэг маркетингийн технологи ашиглаж болно. Энэ зөвшөөрөл нь зээлийн хүсэлт гаргах заавал нөхцөл биш.</p></div>
      </section>
      <section>
        <span>04</span>
        <div><h2>Facebook ба Messenger</h2><p>Манай Facebook Page-ийн чатбот нь автомашины зар, идэвхтэй зээлийн санал харуулах, зээлийн ерөнхий мэдээлэл өгөх, хүсэлт бүртгэхэд ашиглагдана. Чатботоор өгсөн мэдээлэл нь Zentro-ийн харилцагчийн удирдлагын системд Facebook эх сурвалжтай хүсэлт хэлбэрээр хадгалагдаж болно.</p><p>Нийтлэл харсан хэрэглэгчдийн reach, impression, engagement зэрэг статистикийг нэгтгэсэн байдлаар авна. Facebook нь нийтлэл харсан хүн бүрийн утас, и-мэйлийг бидэнд өгдөггүй; зөвхөн хэрэглэгч өөрөө хүсэлтээр өгсөн холбоо барих мэдээлэл хадгалагдана.</p><p>Facebook болон Messenger-ийн өөрийн өгөгдөл боловсруулах ажиллагаа Meta-ийн нөхцөл, нууцлалын бодлогоор давхар зохицуулагдана.</p></div>
      </section>
      <section>
        <span>05</span>
